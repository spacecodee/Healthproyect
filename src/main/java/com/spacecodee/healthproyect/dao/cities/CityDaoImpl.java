...
public class CityDaoImpl implements ICityDao {
    ...
    @Override
    public ObservableList<CityTable> loadTable() {
        Connection conn = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
        ObservableList<CityTable> cities = FXCollections.observableArrayList();
    ...
    @Override
    public ObservableList<CityTable> findByNameTable(String cityName) {
        Connection conn = null;
        PreparedStatement pst = null;
        ResultSet rs = null;
        ObservableList<CityTable> cities = FXCollections.observableArrayList();
    ...
    private void returnResults(ResultSet rs, ObservableList<CityTable> cities) throws SQLException {
        while (rs.next()) {
            var cityModel = new CityTable(
                    rs.getInt("id_city"),
